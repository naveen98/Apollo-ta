...
public class CamapignCreationSteps {
    ...
    public void i_navigate_to_campaign_module_for_count_verification() {
        ...
        ExtentTestManager.logPass("Campaign details validated successfully");
            ...
            try {
                ...
                if (!campaigndetailsMessages.isEmpty()) {
                    for (String msg : campaigndetailsMessages) {
                        ExtentTestManager.logFail("Campaign details Validation Errors at Row: " + msg);
                    }
                ...
                if (toastMessage != null &&
                        (toastMessage.toLowerCase().contains("campaign") || toastMessage.toLowerCase().contains("saved"))) {

                    // SUCCESS CASE
                    Assert.assertEquals(countAfterEachCreation, countBeforeEachCreation + 1, "Campaign count did not increase");
                    campaignsCreated++;
                    ExtentTestManager.logPass("Campaign created successfully: " + camname);
